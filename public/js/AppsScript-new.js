/**
 * Order Sync with Google Sheet for WooCommerce
 * Google Apps Script
 * ? Future use
 */
...
String.prototype.toRange = function () {
  return OrderSync.getRange(this);
}
...
const OrderSync = {
   ...
   */
  get sheet() {
    return SpreadsheetApp.getActive().getSheetByName(this._config.orderTab);
  },
  ...
  async request() {
    return UrlFetchApp.fetch(
      this._config.baseUrl + "/wp-json/osgsw/v1/action/?action=sync",
      {
        method: "GET",
