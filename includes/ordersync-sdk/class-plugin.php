...
if ( ! class_exists( 'WPPOOL_Plugin' ) ) {
	...
	class WPPOOL_Plugin {
		...
		public static function init( $plugin_id = 'wp_dark_mode', $image_url = null ) {
			...
			add_filter(
				'wppool_plugins',
				function ( $plugins ) use ( $instance, $image_url ) {
		...
		public function set_campaign( $image_url = null, $to = null, $from = null ) {
			...
			add_filter(
				'wppool_plugins',
				function ( $plugins ) use ( $image_url, $to, $from ) {
	 ...
	 * @return mixed
	 */
	function wppool_plugin_init( $plugin_id = 'wp_dark_mode', $image_url = null ) { //phpcs:ignore
